...
dwf.FDwfAnalogOutNodeFrequencySet(hdwf, channel, AnalogOutNodeCarrier, c_double(300))
dwf.FDwfAnalogOutNodeAmplitudeSet(hdwf, channel, AnalogOutNodeCarrier, c_double(2.4))
dwf.FDwfAnalogOutNodeOffsetSet(hdwf, channel,    AnalogOutNodeCarrier, c_double(2.4))
